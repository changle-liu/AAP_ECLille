...
int main(int argc, char *argv[])
{
	...
	Test_Fn("QUICK SORT", Qsort, tab, MAX_ELT/10, m[MODE_TAB_ORDONNE] );
	Test_Fn("QUICK SORT", Qsort, tab, MAX_ELT/10, m[MODE_TAB_ALEATOIRE] );
	Test_Fn("QUICK SORT", Qsort, tab, MAX_ELT/10, m[MODE_TAB_INVERSE] );

	Test_FnV2("QUICK SORT", Qsort, tab, 512, m[MODE_TAB_ORDONNE] );
	Test_FnV2("QUICK SORT", Qsort, tab, 512, m[MODE_TAB_ALEATOIRE] );
	Test_FnV2("QUICK SORT", Qsort, tab, 512, m[MODE_TAB_INVERSE] );
