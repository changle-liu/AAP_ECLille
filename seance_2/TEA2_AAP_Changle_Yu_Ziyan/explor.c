...
char* explor(int n1, int n2 , int n3, int n4, int n5, int n6, int num_goal){
	...
	if((n1==num_goal)||(n2==num_goal)||(n3==num_goal)||(n4==num_goal)||(n5==num_goal)||(n6==num_goal)){
		//si num_goal existe dans les 6 cartons, printe le directement
...
//La fonction develop() est pour chercher bonne solution par à la volée en profondeur d'abord
